...
export const ORDER_WRITE_COLUMNS = [
  ...
  // text[] — the named cautions the Texas review screen showed before the owner
  // chose to file anyway. Null on a clean packet and on every non-TX order.
  // scripts/migrations/2026-09-07-tx-cautions.sql
  'tx_cautions',

  // Owner mailing address
  'owner_street', 'owner_city', 'owner_state', 'owner_zip',
  // Which ad click paid for this order, if any. See lib/attribution.js and
  // scripts/migrations/2026-08-25-attribution.sql.
  'gclid', 'utm',
  ...
  // The partner coupon, written by lib/fulfillOrder.js in the same INSERT as the
  // order. Added 17 Aug 2026 with scripts/migrations/2026-08-17-partner-perk.sql.
  //
  // `perk_code` is not bookkeeping — it is the column lib/referralSettlement.js
  // reads to refuse the $20 referral commission on an order that already took a
  // $20 discount. Without it an order pays both: $40 out on an $89 fee.
  'perk_code', 'perk_discount_cents',
