...
const STATIC_PAGES = [
  ...
  // The 2027 deadline authority page. Deliberately a year-free URL: the whole sector
  // bakes the year into the slug and the title and hand-rewrites every spring, which
  // resets whatever authority the URL had. This one recomputes its year and compounds.
  { url: '/texas/protest-deadline', priority: '0.9', changefreq: 'weekly' },
