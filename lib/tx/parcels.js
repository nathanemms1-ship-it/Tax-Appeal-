...
/**
 * The certified roll year currently loaded. Defined in lib/tx/rollYear.js and
 * re-exported here so the callers that have always read it from this module keep
 * working; imported as well as re-exported because this file uses it as a default
 * parameter and a bare `export ... from` would not bind it locally.
 */
export { ROLL_YEAR } from './rollYear';
