...
import { FORM_REVISION } from './fill50132';
...
export function buildProtest({ parcel, comps, owner = {}, taxYear, filingDate = null,
  ...
  return {
    ...
    form50132: {
      /**
       * DERIVED, never retyped. This read '50-132 • 10-25/27' with a comment
       * beside it saying to re-scrape annually; the live form on 15 Sept 2026 is
       * 03-26/28. Two revisions stale, and nothing compared them because the
       * string was the only copy. It now comes from the file we actually fill.
       */
