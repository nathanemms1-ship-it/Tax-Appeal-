...
export function settle({
   ...
   *
   * There is no UNIQUE constraint on referrals.code (scripts/sql/referrals_code_unique.sql
   * adds one), and register-referrer's uniqueness check is a read-then-insert, so two
   * people registering the same generated code at the same moment both pass it.
   *
