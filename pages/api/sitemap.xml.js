export default function handler(req, res) {
  ...
  const pages = [
    ...
    // Blog — Batch 3
    { path: '/blog/collin-county-property-tax-protest-guide-2026',        changefreq: 'monthly', priority: '0.7' },
    { path: '/blog/bexar-county-property-tax-protest-guide-2026',         changefreq: 'monthly', priority: '0.7' },
    { path: '/blog/dekalb-county-property-tax-appeal-guide-2026',         changefreq: 'monthly', priority: '0.7' },
    { path: '/blog/how-much-can-i-save-protesting-property-taxes-texas',  changefreq: 'monthly', priority: '0.7' },
    { path: '/blog/texas-property-tax-protest-letter-what-to-include',    changefreq: 'monthly', priority: '0.7' },
    // Blog — Batch 4
    { path: '/blog/denton-county-property-tax-protest-guide-2026',        changefreq: 'monthly', priority: '0.7' },
    { path: '/blog/gwinnett-county-property-tax-appeal-guide-2026',       changefreq: 'monthly', priority: '0.7' },
    { path: '/blog/broward-county-property-tax-appeal-guide-2026',        changefreq: 'monthly', priority: '0.7' },
    { path: '/blog/fort-bend-county-property-tax-protest-guide-2026',     changefreq: 'monthly', priority: '0.7' },
    { path: '/blog/montgomery-county-property-tax-protest-guide-2026',    changefreq: 'monthly', priority: '0.7' },
    { path: '/blog/palm-beach-county-property-tax-appeal-guide-2026',     changefreq: 'monthly', priority: '0.7' },
  ];
