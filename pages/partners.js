      ...
      <section style={{padding:'48px 40px',background:C.white,borderTop:`1px solid ${C.border}`}}>
        <div className="container">
          ...
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:20}}>
            {[['Does my client need to enter a code?','No. Your unique link automatically tracks the referral. Your client just clicks and files — nothing extra required.'],['When do I get paid?','At the end of each month we pay via Venmo or ACH bank transfer. There is no minimum balance required.'],['Is there a limit to referrals?','No limit. Refer as many clients as you like. Every completed filing earns you $15.'],['What if a client files again next year?','We email every customer 11 months after their filing with a renewal reminder. If they refile through your link, you earn $15 again.'],['Does TaxAppeal serve all counties?','Yes — all 254 Texas counties, all 67 Florida counties, and all 159 Georgia counties.'],['What does the $79 fee cover?','AI-generated dispute letter preparation, USPS Certified Mail filing with Return Receipt, and full tracking through the appraisal district process.']].map(([q,a])=>(
