          ...
          <div className="hero-grid" style={{display:'grid',gridTemplateColumns:'1fr 400px',gap:48,alignItems:'start'}}>
            <div>
              ...
              <p style={{fontSize:13,color:C.mutedGray,lineHeight:1.7,marginBottom:32}}>
                Filing today in {coverage.servingStates.join(', ')} — all {coverage.texas.served} Texas counties, all {coverage.georgia.served} Georgia counties, and all {coverage.florida.served} Florida counties.
                {!coverage.florida.fullyAutomated && ` ${coverage.florida.handFiled} Florida counties are still filed by hand while we confirm their VAB address by phone; your client is told before they pay.`}
              </p>
