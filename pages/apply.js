  ...
  return (
    <div className="page-grid">
      ...
      <div>
        ...
        <p style={{ fontSize: 20, fontWeight: 700, color: "#1B3A6B", marginBottom: 24, fontFamily: "'DM Serif Display', serif", lineHeight: 1.3 }}>
        ...
        <p style={{ fontSize: 14, color: C.bodyGray, lineHeight: 1.7, marginBottom: 28, fontFamily: "'DM Sans', sans-serif" }}>
          Nearly 50% of properties are over-assessed — meaning millions of homeowners are overpaying on their taxes every year. TaxAppeal finds the discrepancy, builds your case with real comparable sales data, and files your protest for a flat $79 fee.
        </p>
  ...
  return (
    <div style={{ maxWidth: 640, margin: "0 auto", padding: "40px 16px", textAlign: "center" }}>
      ...
      <p style={{ fontSize: 14, color: C.bodyGray, lineHeight: 1.6, marginBottom: 32, fontFamily: "'DM Sans', sans-serif" }}>
        We're pulling live data from county appraisal records, searching comparable sales, and drafting your dispute letter. This takes about 60 seconds.
      </p>
      ...
      <div>
        ...
        <div style={{ background: C.white, border: `1.5px solid ${C.border}`, borderRadius: 10, overflow: "hidden", marginBottom: 20 }}>
          ...
          <div style={{ maxHeight: 160, overflowY: "auto", padding: "14px 16px", fontSize: 12, color: C.bodyGray, fontFamily: "'DM Sans', sans-serif", lineHeight: 1.7 }}>
            ...
            <p><strong>5. No refunds after filing.</strong> The $79 fee is non-refundable once your certified mail has been sent. If we made an error, we'll correct it at no charge.</p>
        ...
        {[
          ...
          "I understand the $79 fee is non-refundable once my dispute letter has been filed, and I agree to TaxAppeal's Terms of Service.",
        ].map((text, i) => (
...
Justification basis: ${issueCount} property issue${issueCount !== 1 ? "s" : ""} documented${overAssessedPct > 0 ? ", property over-assessed by approx " + Math.round(overAssessedPct) + "% vs market" : ""}\n\n${issuesBlock}\n\n${districtBlock}\n\nOWNER NOTES: ${property.notes || "None."}\n\nLETTER REQUIREMENTS:\n1. The letter must open with ONLY the owner contact block in this exact order — no TaxAppeal branding, no agent info at top:
   [Owner Full Name]
   [Owner Property Address]
   [Owner Email]

2. Then the date: June 15, 2026

3. Then the recipient address block:
   [${appraisalDistrict ? appraisalDistrict.districtName : county + " Appraisal District"}]
   [District mailing address]

4. Then the RE line — use EXACTLY this text, no variations: RE: NOTICE OF PROTEST OF PROPERTY VALUATION

5. Section "SUBJECT PROPERTY DESCRIPTION": list every characteristic with exact numbers — never write "on file"\n6. Section "PROPERTY DEFECTS & CONDITIONS": cite each selected issue, explain market value impact\n7. Section "COMPARABLE SALES EVIDENCE": 4-5 real recent sales from ZIP ${property.zip} with addresses, prices, dates, sq ft, price/sqft\n8. Section "MARKET CONDITIONS": local market trends supporting lower valuation\n9. Section "LEGAL BASIS": cite ${stateInfo.statute || "applicable state statutes"}, equal and uniform assessment\n10. Demand ${reductionPctDisplay}% reduction: from ${fmt(assessedValue)} to ${fmt(targetReduction)}. This specific percentage is justified by the property conditions, comparable sales, and market data above — cite the evidence that supports this exact figure\n12. STRICTLY FORBIDDEN — Do NOT include any of the following in the letter: requests for a formal hearing, requests to appear before any board or review panel, offers to provide additional documentation, expert testimony, repair estimates, or photographs. The letter ends after the legal basis section.\\n13. Professional closing must include ALL of the following on separate lines:\n    - Owner full name\n    - Owner property address\n    - Owner email: ${account.email}\n    - Filing Agent: TaxAppeal | disputes@taxappealusa.com\n    - Note: "Please direct all correspondence and decisions to both the property owner and our filing agent at disputes@taxappealusa.com"\n\nOutput ONLY the complete formal letter.`;
