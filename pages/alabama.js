...
export default function Alabama(){
  ...
  return(<>
    ...
    <div style={{background:C.darkNavy,padding:"64px 40px 56px",textAlign:"center"}}>
      ...
      <h1 className="ht" style={{fontFamily:"'DM Serif Display',serif",fontSize:46,color:C.white,marginBottom:16,lineHeight:1.15}}>Alabama Property Tax Appeal<br /><span style={{color:C.gold}}>$89 Flat. You Sign, We File.</span></h1>
      <p style={{fontSize:17,color:"#A0B4CC",maxWidth:620,margin:"0 auto 32px",lineHeight:1.6}}>We draft your Board of Equalization appeal, you review and sign it electronically, and we file it via USPS certified mail — before your 30-day deadline.</p>
    ...
    <div style={{background:C.darkNavy,padding:"56px 40px",textAlign:"center"}}>
      ...
      <p style={{color:"#A0B4CC",fontSize:16,marginBottom:32}}>$89 flat. USPS certified mail. All 67 counties.</p>
