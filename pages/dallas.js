...
export default function Dallas() {
  ...
  return (
    <>
      <Head>
        <title>Dallas Property Tax Protest Service | File for $79 | TaxAppeal USA</title>
        ...
        <meta property="og:title" content="Dallas Property Tax Protest — $79 Flat Fee | TaxAppeal USA" />
      ...
      <section style={{background:C.navy,padding:"64px 40px",color:C.white}}>
        <div style={{maxWidth:900,margin:"0 auto"}}>
          ...
          <h1 className="hero-title" style={{fontFamily:"'DM Serif Display',serif",fontSize:42,lineHeight:1.15,marginBottom:16}}>Dallas Property Tax Protest — $79 Flat Fee</h1>
          <p style={{fontSize:18,color:"#8596AF",lineHeight:1.6,maxWidth:640,marginBottom:32}}>Dallas property values have surged in recent years — meaning many homeowners are now over-assessed. TaxAppeal files your formal protest with DCAD backed by comparable sales data for a flat $79.</p>
          ...
          <button className="btn-primary" style={{background:C.gold,color:C.darkNavy,fontSize:17,padding:"18px 44px"}} onClick={go}>File My Dallas Protest — $79 →</button>
        ...
        <div style={{maxWidth:800,margin:"0 auto"}}>
          ...
          <div className="compare-grid" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:20}}>
            ...
            <div style={{background:C.navy,borderRadius:12,padding:24}}>
              ...
              <p style={{fontSize:14,color:"#8596AF",lineHeight:1.7,marginBottom:16}}>Pay $79 once and keep every dollar of your $1,950 savings. No annual fees.</p>
      ...
      <section style={{background:C.navy,padding:"64px 40px",textAlign:"center"}}>
        ...
        <button className="btn-primary" style={{background:C.gold,color:C.darkNavy,fontSize:17,padding:"18px 44px"}} onClick={go}>Start My Dallas Protest — $79 →</button>
      </section>
