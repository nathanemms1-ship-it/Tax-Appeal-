...
export default function Dallas() {
  ...
  return (
    <>
      <Head>
        <title>Dallas Property Tax Protest Service | File for $79 | TaxAppeal</title>
        <meta name="description" content="Protest your Dallas property taxes for $79 flat. Dallas County homeowners save an average of $1,950/year. We file with DCAD via certified mail. No percentage cuts." />
        <link rel="canonical" href="https://www.taxappealusa.com/dallas" />
        <meta property="og:title" content="Dallas Property Tax Protest — $79 Flat Fee | TaxAppeal" />
        <meta property="og:description" content="Protest your Dallas property taxes for $79 flat. Dallas County homeowners save an average of $1,950/year. We file with DCAD via certified mail. No percentage cuts." />
        <meta property="og:url" content="https://www.taxappealusa.com/dallas" />
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "description": "Property tax protest letter preparation and USPS certified mail filing for Dallas homeowners in Dallas County.",
      ...
      <section style={{ background: C.navy, padding: "64px 40px", color: C.white }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <h1 className="hero-title" style={{ fontFamily: "'DM Serif Display', serif", fontSize: 42, lineHeight: 1.15, marginBottom: 16 }}>
            Dallas Property Tax Protest — $79 Flat Fee
          </h1>
          ...
          <div className="hero-stats" style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 16, marginBottom: 32 }}>
            {[["82%", "Approval rate"], ["$1,950", "Avg. savings"], ["$79", "Flat fee"], ["Dallas County", "Service area"]].map(([n, l]) => (
              <div key={l} style={{ background: "#0F1F3D", borderRadius: 10, padding: "16px", textAlign: "center" }}>
                <div style={{ fontFamily: "'DM Serif Display', serif", fontSize: n.length > 6 ? 16 : 28, color: C.gold }}>{n}</div>
        ...
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gap: 24 }}>
            {[
              ...
              ["⚖️", "The Law Is On Your Side", "Under Texas Tax Code §41.43, you can also protest unequal appraisal — meaning if your home is assessed higher than comparable properties, you have grounds to protest even if your value is near market."],
            ].map(([icon, title, desc]) => (
          ...
          <div className="district-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
            <div style={{ background: C.white, border: `1.5px solid ${C.border}`, borderRadius: 12, padding: 24 }}>
              ...
              {[
                ...
                ["📞", "(214) 631-0910"],
                ["🌐", "dallascad.org"],
                ["📅", "Deadline: May 15 or 30 days after your Notice of Appraised Value"],
                ["⚖️", "Texas Tax Code §41.41 & §41.43"],
              ].map(([icon, text]) => (
            ...
            <div style={{ background: C.navy, borderRadius: 12, padding: 24, color: C.white }}>
              ...
              {[
                "Analyze comparable sales in Dallas",
                "Draft formal protest letter citing Texas Tax Code §41.41 & §41.43",
                "File via USPS certified mail with tracking",
                "You receive copy + tracking number",
                "Keep 100% of your savings",
              ].map(item => (
                <div key={item} style={{ display: "flex", alignItems: "flex-start", gap: 8, marginBottom: 10, fontSize: 13, color: C.gold }}>
                  <span style={{ flexShrink: 0, marginTop: 1 }}>✓</span><span style={{ color: "#cbd5e1" }}>{item}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div className="compare-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
            <div style={{ background: C.white, border: `1.5px solid ${C.border}`, borderRadius: 12, padding: 24 }}>
              ...
              <p style={{ fontSize: 14, color: C.bodyGray, lineHeight: 1.7, marginBottom: 16 }}>On a $1,950 reduction, that's ${Math.round(parseInt(city.avgSavings.replace(/D/g,'')) * 0.35).toLocaleString()} in fees — every year.</p>
            ...
            <div style={{ background: C.navy, borderRadius: 12, padding: 24, color: C.white }}>
              ...
              <p style={{ fontSize: 14, color: "#8596AF", lineHeight: 1.7, marginBottom: 16 }}>Same $1,950 reduction — pay $79 once and keep the rest. Every year after that, savings are 100% yours.</p>
      ...
      <section style={{ background: C.navy, padding: "64px 40px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: 16, color: "#8596AF", marginBottom: 28 }}>Join Dallas homeowners saving money every year. $79 flat — no hidden fees, no percentage cuts.</p>
        <button className="btn-primary" style={{ background: C.gold, color: C.darkNavy, fontSize: 17, padding: "18px 44px" }} onClick={go}>
          Start My Dallas Protest — $79 →
        </button>
      </section>
      ...
      <footer style={{ background: C.darkNavy, padding: "24px 40px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
        ...
        <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
          ...
          <a href="/houston" style={{ color: C.mutedGray, fontSize: 12, textDecoration: "none" }}>Houston</a>
          <a href="/dallas" style={{ color: C.mutedGray, fontSize: 12, textDecoration: "none" }}>Dallas</a>
          <a href="/fort-worth" style={{ color: C.mutedGray, fontSize: 12, textDecoration: "none" }}>Fort Worth</a>
          <a href="/austin" style={{ color: C.mutedGray, fontSize: 12, textDecoration: "none" }}>Austin</a>
          <a href="/atlanta" style={{ color: C.mutedGray, fontSize: 12, textDecoration: "none" }}>Atlanta</a>
          <a href="/miami" style={{ color: C.mutedGray, fontSize: 12, textDecoration: "none" }}>Miami</a>
          <a href="/tampa" style={{ color: C.mutedGray, fontSize: 12, textDecoration: "none" }}>Tampa</a>
