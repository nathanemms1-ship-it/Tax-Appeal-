    ...
    <>
      ...
      <Breadcrumb
        trail={[
          ...
          { name: 'Dallas County', href: '/counties/dallas-county-tx' },
          { name: 'Dallas' },
        ]}
        selfUrl={`${SITE_ORIGIN}/dallas`}
      />
        ...
        <div style={{maxWidth:800,margin:"0 auto"}}>
          ...
          <div className="district-grid" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:20}}>
            <div style={{background:C.white,border:`1.5px solid ${C.border}`,borderRadius:12,padding:24}}>
              ...
              {[["📍","2949 N Stemmons Fwy, Dallas, TX 75247"],["📞","(214) 631-0910"],["🌐","dallascad.org"],["📅",`Deadline: ${DEADLINE} or 30 days after your Notice of Appraised Value`],["⚖️","Texas Tax Code §41.41 & §41.43"]].map(([icon,text]) => (
