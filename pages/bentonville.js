...
const faqs = [
  ...
  ["How much can Bentonville homeowners save?", "Benton County homeowners who successfully appeal save an average of $950 per year in property taxes. TaxAppeal charges a flat $79 — you keep 100% of your savings."],
  ...
  ["Do I need to attend a hearing?", "You or your representative may attend. TaxAppeal files your written protest letter with supporting comparable sales evidence, which many counties accept without requiring a personal appearance. We handle the entire filing process for $79."],
];
...
export default function Bentonville() {
  ...
  return (
    <>
      <Head>
        <title>Bentonville Property Tax Appeal Service | File for $79 | TaxAppeal USA</title>
        <meta name="description" content="Appeal your Bentonville property taxes for $79 flat. Benton County homeowners save an average of $950/year. We file with the Board of Equalization via certified mail before the August 17 deadline." />
        <link rel="canonical" href="https://www.taxappealusa.com/bentonville" />
        <meta property="og:title" content="Bentonville Property Tax Appeal — $79 Flat Fee | TaxAppeal USA" />
        <meta property="og:description" content="Appeal your Bentonville property taxes for $79 flat. Benton County Board of Equalization deadline: August 17, 2026." />
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Service","name":"Bentonville Property Tax Appeal Filing","provider":{"@type":"Organization","name":"TaxAppeal USA"},"areaServed":{"@type":"City","name":"Bentonville"},"offers":{"@type":"Offer","price":"79.00","priceCurrency":"USD"}})}} />
      </Head>
      ...
      <section style={{background:C.navy,padding:"64px 40px",color:C.white}}>
        <div style={{maxWidth:900,margin:"0 auto"}}>
          ...
          <h1 className="ht" style={{fontFamily:"'DM Serif Display',serif",fontSize:42,lineHeight:1.15,marginBottom:16}}>Bentonville Property Tax Appeal — $79 Flat Fee</h1>
          <p style={{fontSize:18,color:"#8596AF",lineHeight:1.6,maxWidth:640,marginBottom:32}}>Northwest Arkansas is the fastest-growing real estate market in the state. Benton County assessments have surged with home values — creating strong grounds for Board of Equalization appeals. TaxAppeal files your certified protest letter for a flat $79.</p>
          <div className="hs" style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr 1fr",gap:16,marginBottom:32}}>
            {[["Aug 17","2026 Deadline"],["$950","Avg. savings"],["$79","Flat fee"],["Benton County","Service area"]].map(([n,l]) => (
          ...
          <button className="btn" style={{background:C.gold,color:C.darkNavy,fontSize:17,padding:"18px 44px"}} onClick={go}>File My Bentonville Appeal — $79</button>
      ...
      <section style={{padding:"56px 40px",background:C.white}}>
        <div style={{maxWidth:700,margin:"0 auto"}}>
          <h2 style={{fontFamily:"'DM Serif Display',serif",fontSize:28,textAlign:"center",marginBottom:10}}>$79 Flat vs. Percentage-Based Firms</h2>
          ...
          <div style={{border:"1.5px solid "+C.border,borderRadius:12,overflow:"hidden"}}>
            <table style={{width:"100%",borderCollapse:"collapse",fontSize:14}}>
              <thead><tr style={{background:C.bg}}><th style={{padding:"12px 16px",textAlign:"left",fontWeight:600}}>Annual savings</th><th style={{padding:"12px 16px",textAlign:"center",fontWeight:600,color:C.navy}}>TaxAppeal ($79 flat)</th><th style={{padding:"12px 16px",textAlign:"center",fontWeight:600,color:"#888"}}>Contingency firm (33%)</th></tr></thead>
              <tbody>{[["$500","$79 fee — you keep $421","$165 fee — you keep $335"],["$1,000","$79 fee — you keep $921","$330 fee — you keep $670"],["$2,000","$79 fee — you keep $1,921","$660 fee — you keep $1,340"]].map(([s,o,t]) => (<tr key={s} style={{borderTop:"1px solid "+C.border}}><td style={{padding:"12px 16px",fontWeight:500}}>{s}/yr</td><td style={{padding:"12px 16px",textAlign:"center",color:C.green,fontWeight:600}}>{o}</td><td style={{padding:"12px 16px",textAlign:"center",color:C.bodyGray}}>{t}</td></tr>))}</tbody>
            </table>
          </div>
        </div>
      </section>
      ...
      <div style={{background:C.navy,padding:"64px 40px",textAlign:"center"}}>
        ...
        <p style={{fontSize:15,color:C.mutedGray,marginBottom:28}}>Don't miss the Benton County Board of Equalization deadline. We handle everything for $79.</p>
        <button style={{background:C.gold,color:C.darkNavy,border:"none",borderRadius:8,padding:"18px 44px",fontSize:17,fontWeight:500,cursor:"pointer",fontFamily:"'DM Sans',sans-serif"}} onClick={go}>Start My Bentonville Appeal — $79</button>
      </div>
