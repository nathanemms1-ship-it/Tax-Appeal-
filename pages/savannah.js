  ...
  return(<>
    ...
    <section style={{background:C.navy,padding:"64px 40px",color:C.white}}>
      <div style={{maxWidth:900,margin:"0 auto"}}>
        <div style={{fontSize:12,color:C.gold,textTransform:"uppercase",letterSpacing:"2px",marginBottom:16}}>Savannah, Georgia \u2014 Property Tax Appeal Service</div>
        <h1 className="ht" style={{fontFamily:"'DM Serif Display',serif",fontSize:42,lineHeight:1.15,marginBottom:16}}>Savannah Property Tax Appeal \u2014 $89 Flat Fee</h1>
        <p style={{fontSize:18,color:"#8596AF",lineHeight:1.6,maxWidth:640,marginBottom:32}}>Savannah homeowners can challenge their Chatham County assessment before the 45-day deadline from your Notice of Assessment. TaxAppeal files your formal appeal for $89 flat.</p>
        <div className="hs" style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr 1fr",gap:16,marginBottom:32}}>
          {[["45 days","Appeal window"],["40%","Assessment ratio"],["$89","Flat fee"],["Chatham Co.","Service area"]].map(([n,l])=>(
        ...
        <button className="btn-p" style={{background:C.gold,color:C.darkNavy,fontSize:17,padding:"18px 44px"}} onClick={go}>File My Savannah Appeal \u2014 $89 \u2192</button>
    ...
    <section style={{padding:"56px 40px",background:C.white}}>
      <div style={{maxWidth:800,margin:"0 auto"}}>
        <h2 style={{fontFamily:"'DM Serif Display',serif",fontSize:28,textAlign:"center",marginBottom:32}}>Why Savannah Homeowners Should Appeal</h2>
        <div className="g2" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:20}}>
          {[["Historic Market Variation","Savannah's historic downtown, Victorian District, and Ardsley Park command premiums that mass appraisal models miss on individual blocks."],["No Filing Fee","Georgia property tax appeals cost nothing. TaxAppeal's $89 is the only cost."],["Annual Right","Georgia allows annual appeals. Each spring Notice of Assessment resets your 45-day window."],["Two-Way Check Included","TaxAppeal reviews comparable sales before filing — we only proceed when evidence supports a reduction."]].map(([title,desc])=>(
    ...
    <section style={{padding:"56px 40px",background:C.bg}}>
      <div style={{maxWidth:720,margin:"0 auto"}}>
        <h2 style={{fontFamily:"'DM Serif Display',serif",fontSize:28,textAlign:"center",marginBottom:32}}>Savannah Property Tax FAQ</h2>
        {faqs.map(([q,a],i)=>(
    ...
    <div style={{background:C.darkNavy,padding:"56px 40px",textAlign:"center"}}>
      <h2 style={{fontFamily:"'DM Serif Display',serif",fontSize:34,color:C.white,marginBottom:12}}>File Your Savannah Appeal Today</h2>
      <p style={{color:"#A0B4CC",fontSize:16,marginBottom:32}}>$89 flat. 45-day deadline from your Notice of Assessment. No filing fee.</p>
