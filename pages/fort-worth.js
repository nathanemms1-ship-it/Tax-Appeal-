  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://www.taxappealusa.com/fort-worth" key="canonical" />
        <meta property="og:title" content="Fort Worth Property Tax Protest — $89 Flat Fee | TaxAppeal USA" key="og:title" />
        <meta property="og:description" content="Protest your Fort Worth property taxes for $89 flat. We check whether a protest can actually lower your bill before you pay. We mail your protest to TAD via certified mail. No percentage cuts." key="og:description" />
        <meta property="og:url" content="https://www.taxappealusa.com/fort-worth" key="og:url" />
      ...
      <Breadcrumb
        trail={[
          ...
          { name: 'Tarrant County', href: '/counties/tarrant-county-tx' },
          { name: 'Fort Worth' },
        ]}
        selfUrl={`${SITE_ORIGIN}/fort-worth`}
      />
      ...
      <section style={{background:C.navy,padding:"64px 40px",color:C.white}}>
        <div style={{maxWidth:900,margin:"0 auto"}}>
          ...
          <div className="hero-stats" style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr 1fr",gap:16,marginBottom:32}}>
            {[["$89","Flat fee"],["0%","Of your savings taken"],["Certified","Mail with tracking"],["Tarrant County","Service area"]].map(([n,l]) => (
      ...
      <section style={{padding:"56px 40px",background:C.white}}>
        <div style={{maxWidth:800,margin:"0 auto"}}>
          ...
          <p style={{fontSize:15,color:C.bodyGray,textAlign:"center",marginBottom:36,lineHeight:1.7}}>Texas gives you the right to protest your appraised value every single year, at no cost to file. Here's why Fort Worth homeowners have especially strong grounds.</p>
        ...
        <div style={{maxWidth:800,margin:"0 auto"}}>
          ...
          <div className="district-grid" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:20}}>
            <div style={{background:C.white,border:`1.5px solid ${C.border}`,borderRadius:12,padding:24}}>
              ...
              {[["📍","2500 Handley-Ederville Rd, Fort Worth, TX 76118"],["📞","(817) 284-0024"],["🌐","tad.org"],["📅",`Deadline: ${DEADLINE} or 30 days after your Notice of Appraised Value`],["⚖️","Texas Tax Code §41.41 & §41.43"]].map(([icon,text]) => (
