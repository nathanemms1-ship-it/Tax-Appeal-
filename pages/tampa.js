...
const faqs = [
  ...
  ["What is the $50 county filing fee?","Florida House Bill 7031 (effective July 2025) requires a mandatory $50 filing fee paid to the Hillsborough County Value Adjustment Board. TaxAppeal pays this fee on your behalf — it's included in your $129 total. You don't need to make a separate payment."],
  ...
  ["How much can Tampa homeowners save?","Tampa homeowners save an average of $2,200 per year when they successfully appeal. At $129 all-in, a successful appeal pays for itself within the first three weeks of savings."],
...
export default function Tampa() {
  ...
  return (
    <>
      <Head>
        <title>Tampa Property Tax Appeal Service | $129 All-In | TaxAppeal USA</title>
        <meta name="description" content="Appeal your Tampa property taxes for $129 all-in ($89 service + $50 county VAB fee). Hillsborough County homeowners save an average of $2,200/year. We file your VAB petition and pay the county fee. No percentage cuts." />
        <link rel="canonical" href="https://www.taxappealusa.com/tampa" />
        <meta property="og:title" content="Tampa Property Tax Appeal — $129 All-In | TaxAppeal USA" />
        <meta property="og:description" content="Appeal your Tampa property taxes for $129 all-in. Hillsborough County homeowners save an average of $2,200/year. We file your VAB petition and pay the mandatory county fee on your behalf." />
      ...
      <section style={{background:C.navy,padding:"64px 40px",color:C.white}}>
        <div style={{maxWidth:900,margin:"0 auto"}}>
          ...
          <h1 className="hero-title" style={{fontFamily:"'DM Serif Display',serif",fontSize:42,lineHeight:1.15,marginBottom:16}}>Tampa Property Tax Appeal — $129 All-In</h1>
          <p style={{fontSize:18,color:"#8596AF",lineHeight:1.6,maxWidth:640,marginBottom:16}}>Tampa home values have risen dramatically and Hillsborough County assessments frequently exceed actual market value. TaxAppeal files your formal VAB petition and pays the mandatory county fee — all for $129 total.</p>
          {/* Pricing breakdown */}
          ...
          <div className="hero-stats" style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr 1fr",gap:16,marginBottom:32}}>
            {[["82%","Approval rate"],["$2,200","Avg. savings"],["$129","All-in total"],["Hillsborough","Service area"]].map(([n,l]) => (
          ...
          <button className="btn-primary" style={{background:C.gold,color:C.darkNavy,fontSize:17,padding:"18px 44px"}} onClick={go}>File My Tampa Appeal — $129 All-In →</button>
      ...
      <section style={{padding:"56px 40px",background:C.white}}>
        <div style={{maxWidth:800,margin:"0 auto"}}>
          ...
          <p style={{fontSize:15,color:C.bodyGray,textAlign:"center",marginBottom:36}}>Most Tampa property tax firms charge 25–40% of your savings every year. Here's how TaxAppeal's $129 all-in compares.</p>
          <div className="compare-grid" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:20}}>
            ...
            <div style={{background:C.navy,borderRadius:12,padding:24}}>
              ...
              <p style={{fontSize:14,color:"#8596AF",lineHeight:1.7,marginBottom:16}}>Same $2,200 reduction. Pay $129 once (including county fee) and keep $2,071. Every year after is 100% yours.</p>
      ...
      <section style={{background:C.navy,padding:"64px 40px",textAlign:"center"}}>
        ...
        <button className="btn-primary" style={{background:C.gold,color:C.darkNavy,fontSize:17,padding:"18px 44px"}} onClick={go}>Start My Tampa Appeal — $129 All-In →</button>
      </section>
