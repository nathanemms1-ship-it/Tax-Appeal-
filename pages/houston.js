...
export default function Houston() {
  ...
  return (
    <>
      <Head>
        <title>Houston Property Tax Protest Service | File for $79 | TaxAppeal</title>
        ...
        <meta property="og:title" content="Houston Property Tax Protest — $79 Flat Fee | TaxAppeal" />
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "description": "Property tax protest letter preparation and USPS certified mail filing for Houston homeowners in Harris County.",
      ...
      <section style={{ background: C.navy, padding: "64px 40px", color: C.white }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <h1 className="hero-title" style={{ fontFamily: "'DM Serif Display', serif", fontSize: 42, lineHeight: 1.15, marginBottom: 16 }}>
            Houston Property Tax Protest — $79 Flat Fee
          </h1>
          <p style={{ fontSize: 18, color: "#8596AF", lineHeight: 1.6, maxWidth: 640, marginBottom: 32 }}>
            Harris County homeowners pay some of the highest property taxes in Texas. TaxAppeal files your formal protest with HCAD — backed by comparable sales data and certified mail — for a flat $79.
          </p>
      ...
      <section style={{ padding: "56px 40px", background: C.white }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 15, color: C.bodyGray, textAlign: "center", marginBottom: 36, lineHeight: 1.7 }}>82% of Texas property tax protests result in a reduction. Here's why Houston homeowners have especially strong grounds.</p>
        ...
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div className="district-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
            ...
            <div style={{ background: C.navy, borderRadius: 12, padding: 24, color: C.white }}>
              ...
              {[
                "Analyze comparable sales in Houston",
        ...
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div className="compare-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
            <div style={{ background: C.white, border: `1.5px solid ${C.border}`, borderRadius: 12, padding: 24 }}>
              ...
              <p style={{ fontSize: 14, color: C.bodyGray, lineHeight: 1.7, marginBottom: 16 }}>On a $2,100 reduction, that's ${Math.round(parseInt(city.avgSavings.replace(/D/g,'')) * 0.35).toLocaleString()} in fees — every year.</p>
            ...
            <div style={{ background: C.navy, borderRadius: 12, padding: 24, color: C.white }}>
              ...
              <p style={{ fontSize: 14, color: "#8596AF", lineHeight: 1.7, marginBottom: 16 }}>Same $2,100 reduction — pay $79 once and keep the rest. Every year after that, savings are 100% yours.</p>
