      ...
      <div style={{ background: '#f4f6f9', minHeight: '100vh', padding: '40px 20px', fontFamily: "'Helvetica Neue', Arial, sans-serif" }}>
        <div style={{ maxWidth: 760, margin: '0 auto', background: '#fff', borderRadius: 8, padding: '48px 52px', boxShadow: '0 2px 8px rgba(0,0,0,0.07)' }}>
          ...
          <div style={{ fontSize: 15, color: '#444', lineHeight: 1.8 }}>
            ...
            <p>Our service currently supports properties in Texas, Georgia and Florida. Arkansas and Alabama are not served; if you enter a property in either state we tell you so and take no payment.</p>
            <p>In Florida we hold the current Department of Revenue assessment roll for all 67 counties, and we file in every county that has published — or confirmed to us directly — the Value Adjustment Board mailing address and filing fee a petition requires in order to be accepted. Where a county has not done so, <strong>we decline the order rather than take your money</strong>. Nothing is charged, and we ask for your email so we can write to you if that county is confirmed while there is still time to file. Florida counts a petition as filed only when it is physically received with the correct fee, so a guessed address or a short cheque is not a late filing — it is no filing, and it cannot be fixed after the deadline. We reserve the right to expand or restrict supported states and counties at any time.</p>
