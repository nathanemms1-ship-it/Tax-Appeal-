...
const faqs = [
  ["What is the deadline to appeal property taxes in Georgia?", "You have 45 days from the date on your annual Notice of Assessment to file an appeal. Assessment notices are typically mailed between April and June."],
  ["How much can I save by appealing my Georgia property taxes?", "The average Georgia homeowner who appeals saves $800 to $2,200 per year. With TaxAppeal at $79 flat, you keep 100% of those savings."],
  ["What is the success rate for property tax appeals in Georgia?", "Approximately 82% of property tax appeals backed by comparable sales evidence result in a reduction."],
  ["How does Georgia assess property value?", "Georgia assesses property at 40% of fair market value. If the county overestimates your fair market value, your taxable value and your bill are inflated."],
  ["Does TaxAppeal serve all Georgia counties?", "Yes. We serve all 159 Georgia counties including Fulton, Gwinnett, Cobb, DeKalb, Cherokee, Forsyth, Chatham, Richmond, and every other county."],
  ["Can my assessment go up if I appeal in Georgia?", "In rare cases yes. However TaxAppeal reviews all market data before filing to ensure your appeal is well-supported and the risk is minimal."],
  ...
  ["How does TaxAppeal compare to other Georgia firms?", "Most Georgia firms charge 25 to 40% of your savings. On a $1,500 reduction that is $375 to $600 in fees. TaxAppeal charges $79 flat."],
];

const counties = [
  "Fulton County (Atlanta)", "Gwinnett County", "Cobb County (Marietta)", "DeKalb County (Decatur)",
  "Cherokee County", "Forsyth County", "Hall County (Gainesville)", "Henry County",
  "Chatham County (Savannah)", "Richmond County (Augusta)", "Columbia County", "Clayton County",
  "Muscogee County (Columbus)", "Bibb County (Macon)", "Houston County", "Douglas County",
  "Coweta County", "Fayette County", "Paulding County", "Lowndes County (Valdosta)",
  "Bartow County", "Clarke County (Athens)", "Jackson County", "Walton County", "Newton County",
];
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Appeal your Georgia property taxes for a flat $79 fee. We draft your dispute letter with comparable sales data and file via USPS certified mail. All 159 Georgia counties." />
      ...
      <section style={{ background: C.navy, padding: "64px 40px", color: C.white }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <h1 className="hero-title" style={{ fontFamily: "'DM Serif Display', serif", fontSize: 42, lineHeight: 1.15, marginBottom: 16 }}>Appeal Your Georgia Property Taxes for $79 Flat</h1>
          <p style={{ fontSize: 18, color: "#8596AF", lineHeight: 1.6, maxWidth: 640, marginBottom: 32 }}>
            Stop overpaying. We draft a formal appeal letter backed by comparable sales data, legal citations under O.C.G.A. 48-5-311, and file it via USPS certified mail. Flat $79. No contingency fees. Keep 100% of your savings.
          </p>
          ...
          <button className="btn-primary" style={{ background: C.gold, color: C.darkNavy, fontSize: 17, padding: "18px 44px" }} onClick={go}>File My Georgia Appeal — $79</button>
      ...
      <section style={{ padding: "56px 40px", background: C.bg }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 15, color: C.bodyGray, textAlign: "center", marginBottom: 36, lineHeight: 1.7 }}>Most Georgia firms charge 25 to 40% of your savings. Here is how TaxAppeal compares.</p>
      ...
      <section style={{ padding: "56px 40px", background: C.white }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <h2 style={{ fontFamily: "'DM Serif Display', serif", fontSize: 30, textAlign: "center", marginBottom: 12 }}>We Serve All 159 Georgia Counties</h2>
          ...
          <div className="counties-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
            ...
            <div style={{ fontSize: 13, color: C.navy, fontWeight: 500, padding: "8px 0" }}>+ 134 more counties</div>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: C.navy, padding: "64px 40px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: 16, color: "#8596AF", marginBottom: 28 }}>Join thousands of Georgia homeowners saving money every year. $79 flat. No hidden fees.</p>
        <button className="btn-primary" style={{ background: C.gold, color: C.darkNavy, fontSize: 17, padding: "18px 44px" }} onClick={go}>Start My Georgia Appeal — $79</button>
      </section>
