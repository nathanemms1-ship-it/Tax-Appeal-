...
export default function Austin() {
  ...
  return (
    <>
      <Head>
        <title>Austin Property Tax Protest Service | File for $79 | TaxAppeal USA</title>
        <meta name="description" content="Protest your Austin property taxes for $79 flat. Travis County homeowners save an average of $2,400/year. We file with TCAD via certified mail. No percentage cuts." />
        <link rel="canonical" href="https://www.taxappealusa.com/austin" />
        <meta property="og:title" content="Austin Property Tax Protest — $79 Flat Fee | TaxAppeal USA" />
        <meta property="og:description" content="Protest your Austin property taxes for $79 flat. Travis County homeowners save an average of $2,400/year. We file with TCAD via certified mail. No percentage cuts." />
      ...
      <section style={{background:C.navy,padding:"64px 40px",color:C.white}}>
        <div style={{maxWidth:900,margin:"0 auto"}}>
          ...
          <h1 className="hero-title" style={{fontFamily:"'DM Serif Display',serif",fontSize:42,lineHeight:1.15,marginBottom:16}}>Austin Property Tax Protest — $79 Flat Fee</h1>
          <p style={{fontSize:18,color:"#8596AF",lineHeight:1.6,maxWidth:640,marginBottom:32}}>Austin home values surged dramatically in recent years and are now correcting — meaning many Travis County homeowners are significantly over-assessed. TaxAppeal files your TCAD protest for a flat $79.</p>
          <div className="hero-stats" style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr 1fr",gap:16,marginBottom:32}}>
            {[["82%","Approval rate"],["$2,400","Avg. savings"],["$79","Flat fee"],["Travis County","Service area"]].map(([n,l]) => (
          ...
          <button className="btn-primary" style={{background:C.gold,color:C.darkNavy,fontSize:17,padding:"18px 44px"}} onClick={go}>File My Austin Protest — $79 →</button>
        ...
        <div style={{maxWidth:800,margin:"0 auto"}}>
          ...
          <div className="compare-grid" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:20}}>
            ...
            <div style={{background:C.navy,borderRadius:12,padding:24}}>
              ...
              <p style={{fontSize:14,color:"#8596AF",lineHeight:1.7,marginBottom:16}}>Pay $79 once and keep every dollar of your $2,400 savings. No annual fees.</p>
      ...
      <section style={{background:C.navy,padding:"64px 40px",textAlign:"center"}}>
        ...
        <p style={{fontSize:16,color:"#8596AF",marginBottom:28}}>Join Austin homeowners saving money every year. $79 flat — no hidden fees, no percentage cuts.</p>
        <button className="btn-primary" style={{background:C.gold,color:C.darkNavy,fontSize:17,padding:"18px 44px"}} onClick={go}>Start My Austin Protest — $79 →</button>
      </section>
